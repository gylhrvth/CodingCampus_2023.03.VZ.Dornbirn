...
public class BonusAusfgabe4Gewinnt {
    ...
    public static void printBoardEmptySpace(){
        for (int emptySpaceI = 0; emptySpaceI < 8; emptySpaceI++) {
            for (int emptySpaceJ = 0; emptySpaceJ < 8; emptySpaceJ++) {
    ...
    public static void printBoard(){
        ...
        for (int boardDesign = 0; boardDesign < 8; boardDesign++) {
            System.out.print("| ");
            for (int boardDesign2 = 0; boardDesign2 < 8; boardDesign2++) {
