...
public class ListPerformance {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Vector: " + measure(() -> fillAtEnd(new Vector<>(), FILL_VALUE, FILLS_FOR_END)) + " ms");
        ...
        System.out.println("Vector: " + measure(() -> fillAtStart(new Vector<>(), FILL_VALUE, FILLS_FOR_START)) + " ms");
