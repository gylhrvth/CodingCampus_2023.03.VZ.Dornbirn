...
public class RehearsalRegularExpressions {
    public static void main(String[] args) {
        ...
        text = "Hallo";
        System.out.println(text.matches(".*allo"));

        String gesplitted = "Heute wird          ein guter Tag!\n\n\nHeute wird der beste Tag überhaupt! Heute wird ein spitzen super Tag!";

        String[] strings = gesplitted.split("[ \n]+");
        System.out.println(strings[4]);
        System.out.println(Arrays.toString(strings));

        System.out.println(Texts.HESSE.split("Hesse").length);
    }
}
